        ...
        submitBtn.addActionListener(e -> {
            ...
            try {
                if (dao.requestLoan(currentUser.getId(), bookId, loanType)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Loan request rejected: duplicate request or no stock available", "Request Rejected", JOptionPane.WARNING_MESSAGE);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "couldnt process loan request","error", JOptionPane.ERROR_MESSAGE);
            }
        });
