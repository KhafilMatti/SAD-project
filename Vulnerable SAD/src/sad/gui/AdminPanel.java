...
public class AdminPanel extends JPanel {
    ...
    private void loadUsers() {
        try {
            ...
            //Vulnerability 3: password in plain text
            String[] columns = {"ID", "Username", "Password", "Full Name", "Email", "Role", "College ID"};
            DefaultTableModel model = new DefaultTableModel(columns, 0);
            
            for (User u : users) {
                model.addRow(new Object[]{
                    u.getId(), u.getUsername(),u.getPassword(), u.getFullName(),
