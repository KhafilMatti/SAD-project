...
public class BookshopDAO {
    ...
    public User login(String username, String password) throws SQLException {
        ...
        try {
            ...
            // VULNERABILITY: SQL Injection possible - for students to fix
    ...
    public boolean requestLoan(int userId, int bookId, String loanType) throws SQLException {
        ...
        try {
            ...
            String checkLoanSql = "SELECT COUNT(*) FROM loans " + "WHERE user_id = ? AND book_id = ? AND status IN ('PENDING', 'APPROVED')";
